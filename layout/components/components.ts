...
export const getFamilyIcon = ({icon, familyName}:Family) => `<div style="line-height:1.2mm;text-align:center; border:1px solid white;border-radius:5%;font-size: 6px; font-weight:bold;background-color:rgba(0, 0, 0, .3);color:white;padding:.2mm;" >
