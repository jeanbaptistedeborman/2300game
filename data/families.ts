...
export const merchant:Family = {
    flavourText:"Sous leurs dehors rationnels, ces marchands croient littéralement au père Noël qui détenait la prospérité des anciens. Ils essaient au cours de longues cérémonies de le convaincre de redescendre sur terre malgré qu'il n'y ait plus de neige ni de sapins.",
