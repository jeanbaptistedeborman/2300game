...
import {
    ...
    getHangGliderIllustration, getHouseIllustration,
...
export const cards: Card[] = [
    ...
    },
    {
        ...
        number:2,
        type: Type.TRIBE,
        title: "Ville Marchande",
        text: '',
        abilities: [simpleMerchantSettlement],
        handicaps: [],
        allowedTerrain: Terrain.DESERT,
    },
    {
    ...
    },
    {
        ...
        number:1,
        type: Type.TRIBE,
        title: "Laisser le passé au passé",
        text: '',
    ...
    {
        title: "Compagnie marchande Père Noël",
    ...
    {     title: "Merveilles lointaines",
        number:2,
        type: Type.TRIBE,
        text: '',
        abilities: [trade, longTravel],
        allowedTerrain: Terrain.SAVANNA,
    },
